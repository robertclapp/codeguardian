...
export const brandingSettings = mysqlTable("branding_settings", {
  ...
  // Typography
  headingFont: varchar("heading_font", { length: 100 }).default("Inter"),
  ...
  showMission: int("show_mission").default(1),
  showBenefits: int("show_benefits").default(1),
  showTeamSection: int("show_team_section").default(0),
